...
const NextPrev: FC<NextPrevProps> = ({
  ...
  return (
    ...
    >
      {!onlyNext && (
        <button
          className={`${btnClassName} ${
            !onlyPrev ? "mr-2" : ""
          } border-neutral-200 dark:border-neutral-600 rounded-full flex items-center justify-center ${
            focus === "left" ? "border-2" : ""
          }`}
          onClick={(e) => {
            e.preventDefault();
      ...
      {!onlyPrev && (
        <button
          className={`${btnClassName}  border-neutral-200 dark:border-neutral-600 rounded-full flex items-center justify-center ${
