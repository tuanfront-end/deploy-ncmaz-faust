...
const MyBubbleMenu: FC<MyBubbleMenuProps> = ({ editor }) => {
  ...
  const renderItem = (item: TiptapBarItem) => {
    return (
      <button
        className={`p-1.5 text-neutral-300 hover:text-white dark:text-neutral-700 dark:hover:text-black  ${
  ...
  return (
    //   @ts-ignore
    <BubbleMenu
      className="p-2 bg-neutral-800 dark:bg-neutral-200 flex justify-center rounded-xl"
      editor={editor}
